...
def estimate(model, solver, data, theta0=[0,0], twostep=True):
    ...
    # 2. find p non-parametrically by the relative frequencies of each milage change (Step 1)
    ...
    # 4. call BHHH optimizer for loglikelihood functuon (Step 2)
    ...
    # 6. estimate RC, c and p alltogether (step 3)
    if twostep:
